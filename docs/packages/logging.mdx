...
Page describes how to manage logs is much more convenient than it is
...
Also you can use built in workspace custom NestJS compatible logger `@tinybudgie/logger`
...
[Don't trust, verify!](https://github.com/temarusanov/nx/tree/main/libs/external/logger)
