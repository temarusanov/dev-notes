...
Let's take a look at our authorization example and plans in more depth.
...
For now, I don't have `.forRootAsync()` function in my libraries. But you can find docs about that in 
...
export class AuthService {
    ...
    async signUp() {
        ...
        await this.authEventStream.publish({
